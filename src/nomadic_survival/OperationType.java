...
public class OperationType {
    ...
    public static List<OperationType> getAllForConditionOrGroup(ConditionGenDataSpec mcSpec) {
        ...
        if(mcSpec != null) {
            boolean isValidGroup = mcSpec.getGroup() != null
                    && ConditionMultipliers.INSTANCE_REGISTRY.containsKey(mcSpec.getId());
    ...
    private String id, name, requiredConditionGroup, outputID, relatedIndustryID, skillReqID, skillReqExcuse,
            shortName, placeDesc, introProse, placeName, batchName, batchDoName, despoilName, despoilDesc, batchesName,
            stillAvailableProse;
    private float occurrenceWeight, hazardScale, costVariance, abundanceCostMult, skillReqChance,
    ...
    public String getRelatedIndustryID() {
        return relatedIndustryID;
    }
    ...
    public boolean isRiskInvolved() { return  getCostVariance() > 0; }
    ...
    public float getOccurrenceWeight(MarketConditionAPI condition) {
        ...
        if(group.equals(getRequiredConditionGroup())) {
            ConditionMultipliers mults = ConditionMultipliers.get(condition.getId());
    ...
    public OperationType(JSONObject data) throws JSONException {
        ...
        relatedIndustryID = data.getString("related_industry_id");
        ...
        // Transaction data
        outputCount = data.getInt("output_count");
        ...
        costVariance = (float) data.getDouble("cost_variance");
